...
class TestPuzzle(TestCase):
    ...
    def test_puzzle_hard(self):
        self.me = Solver()
        
        self.me.puzzle[(1, 1)].value = 9 
        self.me.puzzle[(3, 1)].value = 2
        self.me.puzzle[(8, 1)].value = 3

        self.me.puzzle[(2, 2)].value = 3
        self.me.puzzle[(5, 2)].value = 4
        self.me.puzzle[(7, 2)].value = 9
        self.me.puzzle[(8, 2)].value = 5

        self.me.puzzle[(4, 3)].value = 9

        self.me.puzzle[(4, 4)].value = 7
        self.me.puzzle[(6, 4)].value = 8
        self.me.puzzle[(6, 4)].value = 1

        self.me.puzzle[(1, 5)].value = 6
        self.me.puzzle[(5, 5)].value = 2
        self.me.puzzle[(6, 6)].value = 5

        self.me.puzzle[(4, 6)].value = 6
        self.me.puzzle[(6, 6)].value = 1
        self.me.puzzle[(8, 6)].value = 9

        self.me.puzzle[(1, 7)].value = 3
        self.me.puzzle[(2, 7)].value = 5
        self.me.puzzle[(8, 7)].value = 8
        self.me.puzzle[(9, 7)].value = 4

        self.me.puzzle[(5, 8)].value = 1

        self.me.puzzle[(1, 9)].value = 7
        self.me.puzzle[(2, 9)].value = 8
